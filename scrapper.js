...
async function startScrap(){
    try{
        ...
        for(let i=0;i<rawObjects.length;i++){
            ...
            obj.isScrapped=true
            obj.description='Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium asperiores provident quidem, maxime recusandae voluptate incidunt quo cumque harum? Dolorum, enim corrupti quod eum fuga officia hic commodi nam ducimus!'
            result.push(obj)
